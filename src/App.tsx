import GabBook from "./components/GabBook";
import { GAB_DONATE, GAB_EMAIL, GAB_INSTAGRAM, GAB_LOGO_URL, GAB_SITE } from "./data/constants";
    ...
    <div className="app-shell">
      <header className="site-header">
        ...
        >
          <img
            ...
            width={280}
            height={300}
            alt="Logo G.A.B — Grupo de Ayuda a Bodegueros"
            decoding="async"
          />
        </a>
        <p className="site-header__eyebrow">Grupo de Ayuda a Bodegueros</p>
        <h1 className="site-header__title">G.A.B</h1>
        <p className="site-header__tagline">
          Preview del libro · Historias de bodegueros rescatados
        </p>
      </header>
      ...
      <footer className="site-footer" id="pedido">
        <div className="cta-row">
          ...
          <a className="btn btn--secondary" href={GAB_EMAIL}>
            Reserva tu libro
          </a>
